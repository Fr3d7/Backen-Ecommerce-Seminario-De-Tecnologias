        ...
        try
        {
            ...
            if(!usuarioManager.Users.Any())
            {
                var usuarioAdmin = new Usuario
                {
                    Nombre = "Fredy",
                    Apellido = "Lopez",
                    Email = "flopezp11@miumg.edu.gt",
                    UserName = "FREDY.LOPEZ",
                    Telefono = "45106549",
                    AvatarUrl = "https://res.cloudinary.com/dc2nxuxix/image/upload/v1754417175/perfil_tujpvn.png",
                };
                await usuarioManager.CreateAsync(usuarioAdmin, "PasswordFredy123$");
